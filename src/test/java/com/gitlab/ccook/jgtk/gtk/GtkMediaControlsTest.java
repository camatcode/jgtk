...
public class GtkMediaControlsTest extends JGTKJUnitTest {
    @Override
    protected void testGtkElement(GtkApplication gtkApplication) {
        ...
        GtkMediaControls controls = new GtkMediaControls(stream);
        assertTrue(controls.getMediaStream().isDefined());
        assertEquals(controls.getMediaStream().get(), stream);
        w.setChild(controls);
